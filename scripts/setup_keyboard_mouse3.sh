...
########################################
sudo mkdir "$G/functions/hid.usb0"
...
########################################
# 3. Mouse  (hid.usb1, 3‑byte report)
########################################
sudo mkdir "$G/functions/hid.usb1"
echo 2  | sudo tee "$G/functions/hid.usb1/protocol"    # mouse
echo 1  | sudo tee "$G/functions/hid.usb1/subclass"
echo 3  | sudo tee "$G/functions/hid.usb1/report_length"
# 3‑byte relative mouse descriptor
echo -ne '\x05\x01\x09\x02\xa1\x01\x09\x01\xa1\x00\x05\x09\x19\x01\x29\x03\x15\x00\x25\x01\x95\x03\x75\x01\x81\x02\x95\x01\x75\x05\x81\x01\x05\x01\x09\x30\x09\x31\x15\x81\x25\x7f\x75\x08\x95\x02\x81\x06\xc0\xc0' \
...
echo "✅  Composite keyboard + mouse gadget bound on $UDC"
